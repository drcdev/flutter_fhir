...
class CatalogEntry {
  ...
  //  getting list of medications even if not prescribable.Enum enum; //
...
class CatalogEntry_RelatedEntry {
  ...
  //  containerPackage, usedIn, uses, requires, etc.Enum enum; //
  //  triggersis-replaced-by relationtype;

...
class VisionPrescription_LensSpecification {
  ...
  // The eye for which the lens specification applies.Enum enum; // rightleft
  //  eye;
...
class VisionPrescription_Prism {
  ...
  // The relative base, or reference lens edge, for the prism.Enum enum; //
  //  updowninout base;

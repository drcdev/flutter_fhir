...
class StructureDefinition {
  ...
  // Defines the kind of structure that this definition is describing.Enum enum;
  ...
  // How the type relates to the baseDefinition.Enum enum; //
  //  specializationconstraint derivation;
...
class StructureDefinition_Context {
  ...
  //  the extension is.Enum enum; // fhirpathelementextension type;

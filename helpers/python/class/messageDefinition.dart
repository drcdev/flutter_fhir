...
class MessageDefinition {
  ...
  // The impact of the content of the message.Enum enum; //
  ...
  //  only upon error or success, or never.Enum enum; //
  //  alwayson-errorneveron-success responseRequired;

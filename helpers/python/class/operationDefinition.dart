...
class OperationDefinition {
  ...
  // Whether this is an operation or a named query.Enum enum; // operationquery
  //  kind;
...
class OperationDefinition_Parameter {
  ...
  // Whether this is an input or an output parameter.Enum enum; // inout use;
  ...
  //  the parameter type is 'string'.Enum enum; //

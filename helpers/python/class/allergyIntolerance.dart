...
class AllergyIntolerance {
  ...
  //  risk.Enum enum; // allergyintolerance type;
  ...
  //  the identified substance.Enum enum; // lowhighunable-to-assess criticality;
...
class AllergyIntolerance_Reaction {
  ...
  //  potentially considering multiple different manifestations.Enum enum; //

...
class StructureMap_Group {
  ...
  //  combination of types.Enum enum; // nonetypestype-and-types typeMode;
...
class StructureMap_Input {
  ...
  // Mode for this instance of data.Enum enum; // sourcetarget mode;
...
class StructureMap_Source {
  ...
  // How to handle the list mode for this element.Enum enum; //
...
class StructureMap_Structure {
  ...
  // How the referenced structure is used in this mapping.Enum enum; //
...
class StructureMap_Target {
  ...
  // How to interpret the context.Enum enum; // typevariable contextType;
  ...
  // How the data is copied / created.Enum enum; //

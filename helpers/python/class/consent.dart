...
class Consent {
  ...
  // Indicates the current state of this consent.Enum enum; //
...
class Consent_Data {
  ...
  //  restrictions.Enum enum; // instancerelateddependentsauthoredby meaning;
...
class Consent_Provision {
  ...
  //  permitted in root rule, required in all nested rules.Enum enum; // denypermit
  //  type;

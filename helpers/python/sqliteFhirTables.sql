...
"description" TEXT,
_description TEXT,
direction TEXT, --<code> enum: response/request
_direction TEXT,
compareToSourceId TEXT,
_compareToSourceId TEXT,
compareToSourceExpression TEXT,
_compareToSourceExpression TEXT,
compareToSourcePath TEXT,
_compareToSourcePath TEXT,
contentType TEXT,
_contentType TEXT,
expression TEXT,
_expression TEXT,
...
_navigationLinks TEXT,
operator TEXT, --<code> enum: equals/notEquals/in/notIn/greaterThan/lessThan/empty/notEmpty/contains/notContains/eval
_operator TEXT,
"path" TEXT,
_path TEXT,
requestMethod TEXT, --<code> enum: delete/get/options/patch/post/put/head
_requestMethod TEXT,
requestURL TEXT,
_requestURL TEXT,
resource TEXT,
_resource TEXT,
response TEXT, --<code> enum: okay/created/noContent/notModified/bad/forbidden/notFound/methodNotAllowed/conflict/gone/preconditionFailed/unprocessable
_response TEXT,
responseCode TEXT,
_responseCode TEXT,
sourceId TEXT,
...
property TEXT,
_property TEXT,
op TEXT, --<code> enum: =/is-a/descendent-of/is-not-a/regex/in/not-in/generalizes/exists
_op TEXT,
"value" TEXT,
_value TEXT,
...
_validationDate TEXT,
canPushUpdates TEXT,
pushTypeAvailable TEXT,
...
_sourceIdentityCertificate TEXT,
proxyIdentityCertificate TEXT,
_proxyIdentityCertificate TEXT,
proxySignature TEXT,
...
amount REAL,
_amount TEXT,
base TEXT, --<code> enum: up/down/in/out
_base TEXT,

...
//  reference. It SHALL remain the same when the capability statement is stored on different servers.
String url;
...
//  data. For a client, it means the system will search by this profile and process
//  data according to the guidance implicit in the profile. See further discussion
...
//  new identities on the server (that is, the client PUTs to a location where

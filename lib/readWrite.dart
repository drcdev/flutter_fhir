...
//Future <String> ObjectId(String object) async {
//
//  //get current working directory
//  final directory = await getApplicationDocumentsDirectory();
//
...
//      object.substring(1, object.length) +
//      '.txt');
//
//  //if the file doesn't exist, create it, add the id
//  //if it does exist, check if the id is on it, if it isn't, add the id
...
//    String jsonId = json.encode(await file.readAsString());
//    jsonId = rootBundle.loadString
//    var fileId = var file = File('${directory.path}/fhir/' +
//        object[0].toLowerCase() +
//        object.substring(1, object.length) +
//        '.txt');

...
Type ResourceType(String type) {
  ...
  if (type == 'Narrative') Narrative;
  if (type == 'Annotation') Annotation;
  if (type == 'Attachment') Attachment;
  if (type == 'Identifier') Identifier;
  if (type == 'CodeableConcept') CodeableConcept;
  if (type == 'Coding') Coding;
  ...
  if (type == 'SampledData') SampledData;
  if (type == 'Signature') Signature;
  if (type == 'HumanName') HumanName;
  if (type == 'Address') Address;
  if (type == 'ContactPoint') ContactPoint;
  ...
  if (type == 'PractitionerRole') PractitionerRole;
...
dynamic ResourceTypes(String type, Map<String, dynamic> json) {
  ...
  if (type == 'ParameterDefinition')
    return (new ParameterDefinition.fromJson(json));
  if (type == 'RelatedArtifact') return (new RelatedArtifact.fromJson(json));
  if (type == 'TriggerDefinition')
    return (new TriggerDefinition.fromJson(json));
  ...
  if (type == 'ProdCharacteristic')
    return (new ProdCharacteristic.fromJson(json));
  ...
  if (type == 'ElementDefinition')
    return (new ElementDefinition.fromJson(json));
  if (type == 'Account') return (new Account.fromJson(json));
  if (type == 'ActivityDefinition')
    return (new ActivityDefinition.fromJson(json));
  if (type == 'AdverseEvent') return (new AdverseEvent.fromJson(json));
  if (type == 'AllergyIntolerance')
    return (new AllergyIntolerance.fromJson(json));
  if (type == 'Appointment') return (new Appointment.fromJson(json));
  if (type == 'AppointmentResponse')
    return (new AppointmentResponse.fromJson(json));
  ...
  if (type == 'CoverageEligibilityRequest')
    return (new CoverageEligibilityRequest.fromJson(json));
  if (type == 'CoverageEligibilityResponse')
    return (new CoverageEligibilityResponse.fromJson(json));
  ...
  if (type == 'DeviceUseStatement')
    return (new DeviceUseStatement.fromJson(json));
  ...
  if (type == 'DocumentReference')
    return (new DocumentReference.fromJson(json));
  if (type == 'EffectEvidenceSynthesis')
    return (new EffectEvidenceSynthesis.fromJson(json));
  if (type == 'Encounter') return (new Encounter.fromJson(json));
  if (type == 'Endpoint') return (new Endpoint.fromJson(json));
  if (type == 'EnrollmentRequest')
    return (new EnrollmentRequest.fromJson(json));
  if (type == 'EnrollmentResponse')
    return (new EnrollmentResponse.fromJson(json));
  ...
  if (type == 'ExplanationOfBenefit')
    return (new ExplanationOfBenefit.fromJson(json));
  if (type == 'FamilyMemberHistory')
    return (new FamilyMemberHistory.fromJson(json));
  ...
  if (type == 'HealthcareService')
    return (new HealthcareService.fromJson(json));
  if (type == 'ImagingStudy') return (new ImagingStudy.fromJson(json));
  if (type == 'Immunization') return (new Immunization.fromJson(json));
  if (type == 'ImmunizationEvaluation')
    return (new ImmunizationEvaluation.fromJson(json));
  if (type == 'ImmunizationRecommendation')
    return (new ImmunizationRecommendation.fromJson(json));
  if (type == 'ImplementationGuide')
    return (new ImplementationGuide.fromJson(json));
  ...
  if (type == 'MedicationAdministration')
    return (new MedicationAdministration.fromJson(json));
  if (type == 'MedicationDispense')
    return (new MedicationDispense.fromJson(json));
  if (type == 'MedicationKnowledge')
    return (new MedicationKnowledge.fromJson(json));
  if (type == 'MedicationRequest')
    return (new MedicationRequest.fromJson(json));
  if (type == 'MedicationStatement')
    return (new MedicationStatement.fromJson(json));
  if (type == 'MedicinalProduct') return (new MedicinalProduct.fromJson(json));
  if (type == 'MedicinalProductAuthorization')
    return (new MedicinalProductAuthorization.fromJson(json));
  if (type == 'MedicinalProductContraindication')
    return (new MedicinalProductContraindication.fromJson(json));
  if (type == 'MedicinalProductIndication')
    return (new MedicinalProductIndication.fromJson(json));
  if (type == 'MedicinalProductIngredient')
    return (new MedicinalProductIngredient.fromJson(json));
  if (type == 'MedicinalProductInteraction')
    return (new MedicinalProductInteraction.fromJson(json));
  if (type == 'MedicinalProductManufactured')
    return (new MedicinalProductManufactured.fromJson(json));
  if (type == 'MedicinalProductPackaged')
    return (new MedicinalProductPackaged.fromJson(json));
  if (type == 'MedicinalProductPharmaceutical')
    return (new MedicinalProductPharmaceutical.fromJson(json));
  if (type == 'MedicinalProductUndesirableEffect')
    return (new MedicinalProductUndesirableEffect.fromJson(json));
  if (type == 'MessageDefinition')
    return (new MessageDefinition.fromJson(json));
  if (type == 'MessageHeader') return (new MessageHeader.fromJson(json));
  if (type == 'MolecularSequence')
    return (new MolecularSequence.fromJson(json));
  ...
  if (type == 'ObservationDefinition')
    return (new ObservationDefinition.fromJson(json));
  if (type == 'OperationDefinition')
    return (new OperationDefinition.fromJson(json));
  ...
  if (type == 'OrganizationAffiliation')
    return (new OrganizationAffiliation.fromJson(json));
  ...
  if (type == 'PaymentReconciliation')
    return (new PaymentReconciliation.fromJson(json));
  ...
  if (type == 'QuestionnaireResponse')
    return (new QuestionnaireResponse.fromJson(json));
  if (type == 'RelatedPerson') return (new RelatedPerson.fromJson(json));
  if (type == 'RequestGroup') return (new RequestGroup.fromJson(json));
  if (type == 'ResearchDefinition')
    return (new ResearchDefinition.fromJson(json));
  if (type == 'ResearchElementDefinition')
    return (new ResearchElementDefinition.fromJson(json));
  ...
  if (type == 'RiskEvidenceSynthesis')
    return (new RiskEvidenceSynthesis.fromJson(json));
  ...
  if (type == 'SpecimenDefinition')
    return (new SpecimenDefinition.fromJson(json));
  if (type == 'StructureDefinition')
    return (new StructureDefinition.fromJson(json));
  ...
  if (type == 'SubstanceNucleicAcid')
    return (new SubstanceNucleicAcid.fromJson(json));
  ...
  if (type == 'SubstanceReferenceInformation')
    return (new SubstanceReferenceInformation.fromJson(json));
  if (type == 'SubstanceSourceMaterial')
    return (new SubstanceSourceMaterial.fromJson(json));
  if (type == 'SubstanceSpecification')
    return (new SubstanceSpecification.fromJson(json));
  ...
  if (type == 'TerminologyCapabilities')
    return (new TerminologyCapabilities.fromJson(json));
  ...
  if (type == 'VerificationResult')
    return (new VerificationResult.fromJson(json));
  if (type == 'VisionPrescription')
